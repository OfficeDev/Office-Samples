...
The sample add-in demonstrates Excel add-in capabilities to help users using shape API to work as a dashboard

### Features

- Use Table and Range related APIs to insert sample data.
