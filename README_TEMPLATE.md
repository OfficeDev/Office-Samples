...
3. **Preview Your Office Add-in (F5)**
    ...
    **If you meet sideloading errors, please first confirm the following items. If you still have problems, please [Create an issue](https://github.com/OfficeDev/office-js/issues/new/choose) and we'll help you out.** 
